...
global.mztit = process.env.MZTIT ||"MK",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '15_04_2024_SIGMA_MD_7ExFV9C2_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'sɪɢᴍᴀ-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `DARK X SHENA`, // ADD YOUR NAME
